DROP TABLE IF EXISTS ESTADO CASCADE CONSTRAINTS;
CREATE TABLE ESTADO (
    id_estado NUMBER(3) PRIMARY KEY,
    entidad VARCHAR2(100) NOT NULL
);

DROP TABLE IF EXISTS BIEN_AFECTADO CASCADE CONSTRAINTS;
CREATE TABLE BIEN_AFECTADO (
    id_bien_afectado NUMBER(3) PRIMARY KEY,
    descripcion VARCHAR2(100)
);

DROP TABLE IF EXISTS TIPO_DELITO CASCADE CONSTRAINTS;
CREATE TABLE TIPO_DELITO (
    id_tipo_delito NUMBER(5) PRIMARY KEY,
    descripcion VARCHAR2(100)
);

DROP TABLE IF EXISTS SUBTIPO_DELITO CASCADE CONSTRAINTS;
CREATE TABLE SUBTIPO_DELITO (
    id_subtipo_delito NUMBER(5) PRIMARY KEY,
    descripcion VARCHAR2(100)
);

DROP TABLE IF EXISTS MODALIDAD CASCADE CONSTRAINTS;
CREATE TABLE MODALIDAD (
    id_modalidad NUMBER(5) PRIMARY KEY,
    descripcion VARCHAR2(100)
);

DROP TABLE IF EXISTS INDICE_ESTATAL_DELITO CASCADE CONSTRAINTS;
